...
```
metmuseum <command> [arguments] [flags]
```

Run `metmuseum <command> --help` for the full flag list on any command. This
...
per operation you declare in `metmuseum/domain.go`.
