...
Most of these come down to network reality or how metmuseum serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

metmuseum rate-limits like any public site. metmuseum already paces
...
Where a surface is gated, metmuseum reads a cookie or token you supply
...
`metmuseum`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what metmuseum actually did
