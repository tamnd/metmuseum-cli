...
// HTTP behaviour is covered in metmuseum_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "metmuseum://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("metmuseum", "about")
	if err != nil || got.String() != "metmuseum://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want metmuseum://page/about", got.String(), err)
	}
}
